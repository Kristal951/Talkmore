...
const PostDetails = () => {
  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-y-scroll">
      ...
      <div className="flex w-[50%] flex-col h-max mt-4 p-1">
        <Textarea
        ...
        <div className="flex justify-end items-center mt-2">
          <button
            type="submit"
            className="p-2 bg-primary text-white rounded-lg hover:scale-110 transition duration-300"
      ...
      {
        error && (
          <div className="text-center text-red-500 flex ictems-center w-full justify-center h-screen">
            <p>{error}</p>
          </div>
        )
      }
